...
const loyaltyCards = {
	NONE: Symbol.for('no loyaly card'),
	BAHNCARD: Symbol.for('Bahncard'),
	VORTEILSCARD: Symbol.for('VorteilsCard'),
	HALBTAXABO: Symbol.for('HalbtaxAbo'),
	VOORDEELURENABO: Symbol.for('Voordeelurenabo'),
	SHCARD: Symbol.for('SH-Card'),
	GENERALABONNEMENT: Symbol.for('General-Abonnement')
}
